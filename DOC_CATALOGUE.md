...
4. Place new files in the correct section: **Ops Docs** for gap registers, build plans, runbooks, logs, market research; **Repo/Code Docs** for specs, contracts, decisions, and implementation records
